...
const groups = {
  ...common, title: "budget4home - groups", header: "groups"
}

const labels = {
  ...common, title: "budget4home - labels", header: "labels"
}

const expenses = {
  ...common, title: "budget4home - expenses", header: "expenses"
}

const reports = {
  ...common, title: "budget4home - reports", header: "reports"
}
